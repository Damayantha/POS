                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-3 justify-center mt-4">
                             ...
                             {os !== 'windows' && (
                                 <a 
                                     href={assets.find(a => a.name.endsWith('.exe'))?.browser_download_url || 'https://github.com/Damayantha/POS/releases/download/v1.1.0/Cirvex-One-Setup-1.1.0.exe'} 
                                     target="_blank" 
                             ...
                             {os !== 'mac' && (
                                 <a 
                                     href={assets.find(a => a.name.endsWith('.dmg'))?.browser_download_url || 'https://github.com/Damayantha/POS/releases/download/v1.1.0/Cirvex-One-1.1.0.dmg'} 
                                     target="_blank" 
                                     className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-white/10 hover:bg-white/5 hover:border-white/20 transition-all text-sm text-muted-foreground hover:text-white"
                                 >
                             ...
                             {os !== 'linux' && (
                                 <a 
                                     href={assets.find(a => a.name.endsWith('.AppImage'))?.browser_download_url || 'https://github.com/Damayantha/POS/releases/download/v1.1.0/Cirvex-One-1.1.0.AppImage'} 
                                     target="_blank" 
                                     className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-white/10 hover:bg-white/5 hover:border-white/20 transition-all text-sm text-muted-foreground hover:text-white"
                                 >
